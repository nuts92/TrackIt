...
/**
 * IntroductionFragmentOne subclass represents the first step in the introduction wizard.
 */
public class IntroductionFragmentOne extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        introductionImage.setImageResource(R.drawable.introduction_step_one);
