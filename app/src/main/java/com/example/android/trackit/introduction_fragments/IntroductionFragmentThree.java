...
/**
 * IntroductionFragmentThree subclass represents the third step in the introduction wizard.
 */
public class IntroductionFragmentThree extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        introductionImage.setImageResource(R.drawable.introduction_step_three);
